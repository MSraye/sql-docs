...
- Fixed an issue that SSISBuild.exe failed to build projects with encryptSenstiveWithPassword/EncryptAllWithPassword when the project targets sql server 2016.
